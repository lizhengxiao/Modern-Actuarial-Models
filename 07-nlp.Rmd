...
```{r nplm, echo=F, eval=T, out.width="50%",fig.align = 'center',fig.cap="Neural probalilistic language model"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
两者的结构图如下：
```{r w2v, echo=F, eval=T, out.width="30%",fig.align = 'center',fig.cap="Skip-gram model"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/7/skm.png")
```

```{r w2v-2, echo=F, eval=T, out.width="90%",fig.align = 'center',fig.cap="Skip-gram model"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/7/skm2.png")
```

```{r w2v-3, echo=F, eval=T, out.width="30%",fig.align = 'center',fig.cap="Continuous bag of words"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
其词-词共现次数矩阵为：
```{r glove, echo=F, eval=T, out.width="70%",fig.align = 'center',fig.cap="词-词共现次数矩阵"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
这转化为一个加权最小二乘问题：
```{r glove-1, echo=F, eval=T, out.width="50%",fig.align = 'center',fig.cap=""}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
- RNN
```{r rnn, echo=F, eval=T, out.width="70%",fig.align = 'center',fig.cap="RNN"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/7/RNN.png")
```

- LSTM
```{r lstm, echo=F, eval=T, out.width="70%",fig.align = 'center',fig.cap="LSTM"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/7/LSTM_1.png")
```

```{r lstm-1, echo=F, eval=T, out.width="70%",fig.align = 'center',fig.cap=""}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/7/LSTM_2.png")
```

- GRU
```{r gru, echo=F, eval=T, out.width="70%",fig.align = 'center',fig.cap="GRU"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/7/GRU_1.png")
```

```{r gru-1, echo=F, eval=T, out.width="70%",fig.align = 'center',fig.cap=""}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r lstm-s, echo=F, eval=T, out.width="70%",fig.align = 'center',fig.cap="Shallow LSTM"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/7/Shallow LSTM.png")
```

  - Deep LSTM architecture
```{r lstm-d, echo=F, eval=T, out.width="70%",fig.align = 'center',fig.cap="Deep LSTM"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r gru-s, echo=F, eval=T, out.width="70%",fig.align = 'center',fig.cap="Shallow GRU"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
