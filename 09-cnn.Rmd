...
计算过程如下图所示：
```{r,echo=F, eval=T, out.width="60%",fig.align = 'center',fig.cap="Convolution"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r,echo=F, eval=T, out.width="40%",fig.align = 'center',fig.cap="Dilation"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r,echo=F, eval=T, out.width="30%",fig.align = 'center',fig.cap="Activation Functions"}
#knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/9/sigmoid.png");knitr::include_graphics("./plots/9/tanh.png");knitr::include_graphics("./plots/9/relu.png")
```
...
```{r,echo=F, eval=T, out.width="30%",fig.align = 'center',fig.cap="Activation Functions"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
knitr::include_graphics("./plots/9/sigmoid.png")
knitr::include_graphics("./plots/9/tanh.png")
knitr::include_graphics("./plots/9/relu.png")
```
