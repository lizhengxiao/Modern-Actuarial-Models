...
```{r heatplot,echo=F, eval=T, out.width="60%",fig.align = 'center',fig.cap="瑞士男女性死亡率热力图"}
...
```{r kt,echo=F, eval=T, out.width="60%",fig.align = 'center',fig.cap="瑞士男女性kt的估计与预测值"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r,echo=F, eval=T, out.width="60%",fig.align = 'center',fig.cap="RNN初试中选择的数据"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r loss1,echo=F, eval=T, out.width="60%",fig.align = 'center',fig.cap="模型的样本内外损失"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r loss2,echo=F, eval=T, out.width="60%",fig.align = 'center',fig.cap="模型的样本内外损失"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r kt2,echo=F, eval=T, out.width="60%",fig.align = 'center',fig.cap="三种模型下kt的估计与预测值"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r kt3,echo=F, eval=T, out.width="60%",fig.align = 'center',fig.cap="引入性别协变量建模的kt的估计与预测值"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r Box,echo=F, eval=T, out.width="60%",fig.align = 'center',fig.cap="100个不同种子下的损失箱线图"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
...
```{r,echo=F, eval=T, out.width="60%",fig.align = 'center',fig.cap="对数死亡率的观察与预测值"}
knitr::opts_chunk$set(fig.pos = "!H", out.extra = "")
